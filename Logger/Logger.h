...
namespace Logging
{
	...
	public:
		static void attach(std::ostream* pOut)
		{
			_logger.attach(pOut);
		}
		static void start()
		...
		static bool running()
		{
			return _logger.running();
		}
		static void pause(bool doPause)
		{
			_logger.pause(doPause);
		}
		static void paused()
		{
			return _logger.paused();
		}
		static void flush()
		{
			_logger.flush();
