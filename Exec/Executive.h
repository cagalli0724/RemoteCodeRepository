...
*  --------------------
*  ver 2.2 : 02 May 2017
*  - transfer Analysis of source files to PublishRepository
*    by student
*  ver 2.1 : 04 Apr 2017
*  - change the arguments of Command Line
*  - by student
*  ver 2.0 : 07 Mar 2017
*  - By student
*  - add dependency analysis and strong component analysis
*
*  ver 1.4 : 26 Feb 2016
...
namespace CodeAnalysis
{
	...
	public:
		...
		std::string GetDependencyPath() { return dependencyPath_; }
		std::string GetScPath() { return scPath_; }
		void showCommandLineArguments(int argc, char* argv[]);
		bool ProcessingCommandLineForZP(bool &isHasPath, int &i, char* argv[]);
		bool ProcessPCommandLine(bool& isHasPath, char* argv[]);
		...
		std::string GetPublishDir();
		std::vector<File> cppHeaderFiles();
		std::vector<File> cppImplemFiles();
	private:
		
		bool ProcessZCommandLine(bool& isHasPath, char* argv[]);
		void clearActivity();
