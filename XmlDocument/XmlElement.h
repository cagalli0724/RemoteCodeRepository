...
namespace XmlProcessing
{
  ...
  inline std::string TextElement::value()
  {
	  return text_; 
  }
  ...
  {
  public:
    TaggedElement(const std::string& tag) 
		: tag_(tag)
	{
		;
	}
  ...
  inline std::string TaggedElement::tag() 
  {
	  return tag_; 
  }
  ...
  {
  public:
    CommentElement(const std::string& text) 
		: commentText_(text) 
	{
		;
	}
  ...
  public:
    ...
    ProcInstrElement(const std::string& type) 
		: type_(type) 
	{
		;
	}
