...
namespace XmlProcessing 
{
	...
	inline XmlParts::XmlParts() 
		: pToker(nullptr) 
	{
		;
	}

	inline int XmlParts::length() 
	{
		return (int)toks.size(); 
	}

	inline void XmlParts::verbose(bool v) 
	{
		Verbose = v; 
	}

	inline void XmlParts::clear() 
	{
		toks.clear(); 
	}
