...
namespace Scanner
{
	...
	*/
	...
	protected:
		ConsumeState * nextState2(std::locale& loc, int chNext);
		Context* _pContext;
		bool collectChar();
	...
	ConsumeState * ConsumeState::nextState2(std::locale& loc, int chNext)
	{
...
int main()
{
	...
	try
	{
		...
		Toker toker2;
		toker2.returnComments();
		toker2.setSpecialTokens(newSpecialChars);
		in.clear();
