...
{
	std::cout<<"String handling test on server";
...
{
	std::cout<<"Buffer handling test on server";
...
int main(int argc, char* argv[])
{
	...
	try
	{
		...
		std::cout<<"Starting string test on client";
		clientTestStringHandling(si);
		std::cout<<"Starting buffer test on client";
